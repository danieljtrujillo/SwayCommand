...
The registry holds fifteen scenes, listed here in registry order. Registry order fixes nothing on the keyboard — the digit keys index the active project's pool ([ENGINE.md](ENGINE.md#scene-management)).
